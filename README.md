...
> Apri questa pagina in [https://baxeico.github.io/test-distance/](https://baxeico.github.io/test-distance/)
...
* cerca **https://github.com/baxeico/test-distance** ed importa

## Modifica questo progetto ![Badge stato build](https://github.com/baxeico/test-distance/workflows/MakeCode/badge.svg)

Per modificare questa repository in MakeCode.

* apri [https://makecode.microbit.org/](https://makecode.microbit.org/)
* clicca su **Importa** quindi fai clic su **Importa INDIRIZZO**
* incolla **https://github.com/baxeico/test-distance** e clicca importa
...
![Un'immagine renderizzata dei blocchi](https://github.com/baxeico/test-distance/raw/master/.github/makecode/blocks.png)
